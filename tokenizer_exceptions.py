def normalizer_exc_rus(text):
    ...
    abbrev_time_periods = [
        ...
        {ORTH: "гг.", NORM: "годы"},
        {ORTH: "т. г.", NORM: "текущий год"},
        {ORTH: "АВПР", NORM: "Архив_внешней_политики_России"},
        {ORTH: "ПиБ", NORM: "Письма_и_бумаги_имп._Петра_Великого"},
        {ORTH: "ПСЗ-I", NORM: "Первое_Полное_собрание_законов_Российской_империи"},
        {ORTH: "РИО", NORM: "Русское_историческое_общество"},
        {ORTH: "РВИО", NORM: "Русское_военно_историческое_общество"},
        {ORTH: "РГАДА", NORM: "Российский_государственный_архив_древних_актов"},
        {ORTH: "ТРВИО", NORM: "Труды_Русского_военно_исторического_общества"},
        {ORTH: "ФИРИ", NORM: "Санкт_Петербургский_филиал_Института_российской_истории"},
        {ORTH: "ЧОИДР", NORM: "Чтения_в_Обществе_истории_и_древностей_Российских"},
    ...
    abbrev_exception_list = [abbrev_titles, abbrev_literary_phrases, abbrev_person, abbrev_time_periods, abbrev_others]
    for abbrev_list_item in abbrev_exception_list:
        for abbrev in abbrev_list_item:
            # print('{} - {}'.format(abbrev['ORTH'],abbrev['NORM']))
            if text.find(' {}'.format(abbrev['ORTH'])) != -1:
                print('{} - {}'.format(abbrev['ORTH'], abbrev['NORM']))
                # print(text.find(abbrev['ORTH'].lower()))
                str_marker = text.find(' {}'.format(abbrev['ORTH']))
                print(text[str_marker-50:str_marker+100])
            text = text.replace(' {}'.format(abbrev['ORTH']), ' {}'.format(abbrev['NORM']))
    return text
...
def test():
    ...
    normalizer_exc_rus(text)
    print(normalizer_exc_rus(text))
